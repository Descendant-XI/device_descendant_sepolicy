...
BOARD_PLAT_PRIVATE_SEPOLICY_DIR += \
    device/descendant/sepolicy/qcom/private

ifeq ($(TARGET_USES_PREBUILT_VENDOR_SEPOLICY), true)
BOARD_PLAT_PRIVATE_SEPOLICY_DIR += \
    device/descendant/sepolicy/qcom/dynamic \
    device/descendant/sepolicy/qcom/system
else
BOARD_VENDOR_SEPOLICY_DIRS += \
    device/descendant/sepolicy/qcom/dynamic \
    device/descendant/sepolicy/qcom/vendor
endif

ifneq ($(filter msm8960 msm8226 msm8610 msm8974 apq8084 msm8909 msm8916 msm8952 msm8992 msm8994,$(TARGET_BOARD_PLATFORM)),)
BOARD_VENDOR_SEPOLICY_DIRS += \
    device/descendant/sepolicy/qcom/legacy-vendor
endif
